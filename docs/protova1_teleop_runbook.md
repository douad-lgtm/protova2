...
| **Encodeur** | ✅ compte à la main — **80 ticks/tour confirmé** (KY-040 20 PPR ×4, filtre RC + 74HC14) |
| Paramètres ROS corrigés | `ticks_per_rev : 65→80` dans TX.py et ackermann_odom.py (RX.py = doublon, non utilisé) |
