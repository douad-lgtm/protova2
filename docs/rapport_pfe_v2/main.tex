...
\makechapterstyle{altenpro}{%
  ...
  \renewcommand*\printchaptertitle[1]{\chaptitlefont ##1\par\nobreak\vskip 8pt\hrule height 1pt}
  \renewcommand*\afterchaptertitle{\vskip 24pt}
}
\chapterstyle{altenpro}

% titres de sections : noir, gras, alignés à gauche
...
\makeoddhead{altenhead}{\small\leftmark}{}%
  {\includegraphics[height=11pt]{logo_insa.png}\enspace\includegraphics[height=11pt]{logo_alten.png}}
