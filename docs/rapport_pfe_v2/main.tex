...
\makechapterstyle{daleifmodif}{
  ...
  \renewcommand\printchaptertitle[1]{\color{black}\chaptitlefont\raggedleft ##1\par}
}
\makeatother
\chapterstyle{daleifmodif}

% sections en bleu ALTEN
\setsecheadstyle{\Large\bfseries\color{black}}
\setsubsecheadstyle{\large\bfseries\color{black}}
